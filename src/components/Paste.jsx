  ...
  return (
   ...
   <span></span>
      ...
      <div className="flex flex-col gap-y-3">
        ...
        {/* All Pastes */}
        <div className="flex flex-col border-4 border-[rgba(128,121,121,0.3)] bg-white py-4 rounded-[0.4rem]">
          <h2 className="px-4 text-4xl font-bold border-b border-[rgba(128,121,121,0.3)] pb-4">
            All Notes
          </h2>
          <div className="w-full px-4 pt-4 flex flex-col gap-y-5 border-t border-[rgba(128,121,121,0.3)]">
